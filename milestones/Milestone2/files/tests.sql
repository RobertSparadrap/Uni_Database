...
CALL porcedure_to_know_if_there_are_place(1, 13, 5)
;
/*
| Student         | Course | Section | Boolean if there are some place to take this course |
| --------------- | ------ | ------- | --------------------------------------------------- |
...
-- Can the International Student take one specourse because he has the knowledge ?

CALL we_want_to_know_if_the_student_can_take_the_course(1, 13, 5)
;

/*
| Student         | Course | Section | Bool if he can take the course |
| --------------- | ------ | ------- | ------------------------------ |
| Robert Harakaly | DevOps | 5       | 1                              |
*/
